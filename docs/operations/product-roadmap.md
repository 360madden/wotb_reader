...
| L1 | D | HP live session (Oasis Palms victim 3760578; anchor **entity-base**, region ≥ 0x120, correlate **int16** — `VerifyPlayerHpChain` 2026-08-11 pins HP as signed int16 at `[entity+0xB8]`, alive byte +0xBA, healing +0x11E; the `+0x48` from rehearsals is a SYNTHETIC FIXTURE, refuted; `hp-diff --int16 true` is the HP default) | 1 |
