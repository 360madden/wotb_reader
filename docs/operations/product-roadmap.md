...
| P2 | H | HP publication — **APPLIED 2026-08-12 (OD-RECOVERY-092)**: `Verified` via the entity-base chain (final hop `recordOffset 184`, signed int16 at `+0xB8`); 2-replay agreement (Oasis 087 Strict 8/8 + Dead Rail 091 Phase-4 Strict 4/4, `twoReplayRepeatability = true`) |
| P3 | H | Facing/yaw publication — **APPLIED 2026-08-12 (OD-RECOVERY-092)**: `Verified` via the ring-record chain (`recordOffset 48` = `+0x30`), replacing the quarantined candidate; 2-replay agreement (Oasis 088 48/48 + Dead Rail 089 Phase-4 56/56, `twoReplayRepeatability = true`) |
| P4 | H | Pitch/roll publication — **APPLIED 2026-08-12 (OD-RECOVERY-098)**: `Verified` via the ring-record chain (`recordOffset 44` = `+0x2C` pitch, `40` = `+0x28` roll); Phase-4 repeat closed via the rotation-triple reconciliation (`yaw-diff --field pitch\|roll` re-verdicts the SAME OD-088/089 dumps — Oasis 48/48 + Dead Rail 56/56 each, `twoReplayRepeatability = true`); the rotation triple is fully published |
...
| PN-4 | F | **DONE 2026-08-14** — offline scorer plus repeat live CAM-013 aim proof across two content-distinct replays; Dead Rail improved 69.565% -> 72.727% and Oasis/Churchill improved 38.889% -> 46.667% band accuracy; 150 + 161 G2-proven samples, per-shot deltas in the PN-4 handoffs |
