...
| PN-2 | F | **Pen math module** — **DONE 2026-08-13** (`Core/Overlay/ArmorPenetration.cs`, 16 tests): ray-plane hit, incidence, effective armor = thickness/cos(angle), ≥70° ricochet (+3× overmatch), pen-at-range, banded green/yellow/red verdict, per-shell `normalizationAngle`, and the `piercingPower` 2-point range mapping (`ShellSpec.FromPiercingPower`) |
