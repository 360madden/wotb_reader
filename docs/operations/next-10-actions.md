...
|---|---|---|---|---|
| 1 | **Hunt the late Oasis window (~245–274 s) or a replay that actually switches** for A->B->A. Type-32 6-byte field is per-shot, not eShellKind | Phase 6 v0.3 G1 item 2; BLK-0027 | Oasis `01a00e21` 932 samples / 14.1–219.2 s: index `{0}` / kind 3 while reload 0/3. Mixed magazine 3 / kinds 2,3,5. Late shots not covered. Only two local originals | late-window hunt or a new replay; do not promote |
