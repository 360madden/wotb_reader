...
|---|---|---|---|---|
| 1 | **Adjudicate the 0/5 angular shot-join** (published marker is clock-covered but not the 10° hull-to-victim center line) and decide the next exact-ray hypothesis | Phase 6 v0.3 G1 item 5; BLK-0027 | Elevation isolation now has `twoReplayRepeatability` (Dead Rail 5 windows, Oasis 6+). Walk cache + `marker-shots` covered 5/7 Oasis shots within 250 ms; all five missed 10°. Loaded shell and exact armor stay no-go | do not promote; do not loosen the angle and call it ExactGunRay |
