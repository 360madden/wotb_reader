...
| FRESH17 | click registration flaky (blind double-click) | single verified click + SendInput + message-click channel + animation settle + 640×360 window resize (placed at the second monitor's top-left when one is attached, else the primary's; `885a537`, `14633a0`) |
