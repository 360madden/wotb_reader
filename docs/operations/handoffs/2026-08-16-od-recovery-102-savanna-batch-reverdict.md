# OD-RECOVERY-102 — savanna batch position re-verdict (offline)
...
Item 8 re-verdicts the stored savanna batch positions from the item-7 live
...
- Capture: immutable `.data/cluster-batch-retry-20260814-2123.json`
  ...
  250.88 s).
- Decoded ground truth: savanna session
...
The 8 prior misses are the documented savanna memory-apply lag (yaw measured
...
- The savanna/medvedkovo memory-apply lag remains measured, not eliminated; a
