...
2. **Ground-truth verification**: the player's own entity (viewpoint) dealt
   damage in BOTH 11.19.0 replays — Oasis Palms 3760577 (5 events, 2184,
   4 windows at 177.8–274.0s), Dead Rail 2549401 (5 events, 1569, 4 windows
...
4. **Extractor** (`scripts/python/replay-delta-extractor.py`): `--damage-dealt
   ...
   The schedule drops 0/unparseable-damage events (Dead Rail had one — a
...
**Construction trap caught in rehearsal**: my first Oasis Palms build put
