...
2. Deterministically replace player names, clans, account/database identifiers,
   arena identity, timestamps, chat, and every known binary encoding while
   retaining the full packet timeline.
