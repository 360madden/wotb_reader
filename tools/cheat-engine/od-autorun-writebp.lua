...
local MAX_POLL_ROUNDS = 150  -- 300s at 2s interval; covers the full 120s research lease + roll tail (OD-031: a 90s poll expired just before rolling wrote the address file)
